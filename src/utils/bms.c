...
uint8_t bms(void) {
  ...
  while (1) {
    ...
    */
    ...
    cells->voltage[0] =  0x3FFF &
            ((read_register(BQ769200_ADDRESS, BQ769_REG_VC1_HI) << 8) |
             read_register(BQ769200_ADDRESS, BQ769_REG_VC1_LO));


    cells->voltage[1] = 0x3FFF &
            ((read_register(BQ769200_ADDRESS, BQ769_REG_VC2_HI) << 8) |
             read_register(BQ769200_ADDRESS, BQ769_REG_VC2_LO));

	cells->voltage[2] =  0x3FFF &
            ((read_register(BQ769200_ADDRESS, BQ769_REG_VC3_HI) << 8) |
             read_register(BQ769200_ADDRESS, BQ769_REG_VC3_LO));

	cells->voltage[3] =  0x3FFF &
            ((read_register(BQ769200_ADDRESS, BQ769_REG_VC4_HI) << 8) |
             read_register(BQ769200_ADDRESS, BQ769_REG_VC4_LO));

	cells->voltage[4] =  0x3FFF &
            ((read_register(BQ769200_ADDRESS, BQ769_REG_VC5_HI) << 8) |
             read_register(BQ769200_ADDRESS, BQ769_REG_VC5_LO));

      temperature->temperature[0] =
          0x3FFF &
          ((read_register(BQ769200_ADDRESS, BQ769_REG_TS1_HI) << 8) |
